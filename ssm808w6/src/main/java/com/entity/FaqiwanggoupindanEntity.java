...
public class FaqiwanggoupindanEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public FaqiwanggoupindanEntity() {
		
	}
	
	public FaqiwanggoupindanEntity(T t) {
		try {
	 ...
	 * 设置：折后价
	 */
	public void setZhehoujia(Float zhehoujia) {
		this.zhehoujia = zhehoujia;
	}
	/**
	 * 获取：折后价
	 */
	public Float getZhehoujia() {
		return zhehoujia;
	}
	/**
	 * 设置：图片
