 ...
 */
public class WanggoupindanModel  implements Serializable {
	...
	public void setPindanzhehoujia(Float pindanzhehoujia) {
		this.pindanzhehoujia = pindanzhehoujia;
	}
	
	/**
	 * 获取：拼单折后价
	 */
	public Float getPindanzhehoujia() {
		return pindanzhehoujia;
	}
