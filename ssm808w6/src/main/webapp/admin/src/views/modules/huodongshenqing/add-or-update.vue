<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="活动类别" prop="huodongleibie">
          <el-select v-model="ruleForm.huodongleibie" placeholder="请选择活动类别">
            <el-option
                v-for="(item,index) in huodongleibieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="活动类别" prop="huodongleibie">
	      <el-input v-model="ruleForm.huodongleibie"
                placeholder="活动类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="举办地点" prop="jubandidian">
          <el-input v-model="ruleForm.jubandidian" 
              placeholder="举办地点" clearable  :readonly="ro.jubandidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="举办地点" prop="jubandidian">
              <el-input v-model="ruleForm.jubandidian" 
                placeholder="举办地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
