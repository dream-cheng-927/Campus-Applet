    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="个人描述" prop="gerenmiaoshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="个人描述"
                  v-model="ruleForm.gerenmiaoshu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gerenmiaoshu" label="个人描述" prop="gerenmiaoshu">
                    <span>{{ruleForm.gerenmiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
