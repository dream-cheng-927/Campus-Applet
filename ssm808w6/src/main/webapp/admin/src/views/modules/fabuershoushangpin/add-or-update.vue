<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="损坏程度" prop="sunhuaichengdu">
          <el-select v-model="ruleForm.sunhuaichengdu" placeholder="请选择损坏程度">
            <el-option
                v-for="(item,index) in sunhuaichengduOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="损坏程度" prop="sunhuaichengdu">
	      <el-input v-model="ruleForm.sunhuaichengdu"
                placeholder="损坏程度" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="其他说明" prop="qitashuoming">
          <el-input v-model="ruleForm.qitashuoming" 
              placeholder="其他说明" clearable  :readonly="ro.qitashuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="其他说明" prop="qitashuoming">
              <el-input v-model="ruleForm.qitashuoming" 
                placeholder="其他说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="现价" prop="xianjia">
          <el-input v-model="ruleForm.xianjia" 
              placeholder="现价" clearable  :readonly="ro.xianjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="现价" prop="xianjia">
              <el-input v-model="ruleForm.xianjia" 
...
export default {
  ...
  methods: {
    ...
    info(id) {
      this.$http({
        url: `fabuershoushangpin/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.shangpinjieshao = this.ruleForm.shangpinjieshao.replace(reg,'../../../ssm808w6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `fabuershoushangpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fabuershoushangpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
