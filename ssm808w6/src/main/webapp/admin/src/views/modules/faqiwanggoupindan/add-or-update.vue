<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="折后价" prop="zhehoujia">
          <el-input v-model="ruleForm.zhehoujia" 
              placeholder="折后价" clearable  :readonly="ro.zhehoujia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="折后价" prop="zhehoujia">
              <el-input v-model="ruleForm.zhehoujia" 
                placeholder="折后价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuanjia = true;
          ...
          if(o=='zhehoujia'){
            this.ruleForm.zhehoujia = obj[o];
	    this.ro.zhehoujia = true;
            continue;
          }
          if(o=='tupian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `faqiwanggoupindan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.faqiwanggoupindanCrossAddOrUpdateFlag = false;
                  this.parent.search();
